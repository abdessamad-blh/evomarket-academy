...
const sessions = [
  ...
  },
  {
    ...
    bonus: "Séance en ligne le mercredi suivant pour Q&A et défis pratiques",
  },
  {
    date: "14",
    month: "FÉVRIER",
    ...
    bonus: "Séance en ligne le mercredi suivant pour correction & accompagnement",
  },
  {
    date: "21",
    month: "FÉVRIER",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Chaque samedi de 9h à 13h à Amip Casa
          </p>
        </div>
              ...
              <div className="relative p-8">
                ...
                <div className="absolute top-8 right-8 text-center">
                  <div className="bg-primary text-dark rounded-xl p-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
                    ...
                    <p className="text-xs font-bold mt-1">{session.month}</p>
                  </div>
        ...
        <div className="mt-16 text-center space-y-6 animate-fade-in">
          <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-primary/10 to-transparent p-6 rounded-xl border border-primary/20">
              <div className="text-primary mb-2">{Icons.clockLarge}</div>
              <p className="text-white font-bold mb-1">Horaires</p>
              <p className="text-gray-400 text-sm">Chaque samedi<br/>9h à 13h</p>
            </div>
            <div className="bg-gradient-to-br from-primary/10 to-transparent p-6 rounded-xl border border-primary/20">
              <div className="text-primary mb-2">{Icons.certificate}</div>
              <p className="text-white font-bold mb-1">Attestation</p>
              <p className="text-gray-400 text-sm">Officielle<br/>incluse</p>
            </div>
            <div className="bg-gradient-to-br from-primary/10 to-transparent p-6 rounded-xl border border-primary/20">
              <div className="text-primary mb-2">{Icons.laptop}</div>
              <p className="text-white font-bold mb-1">Mode</p>
              <p className="text-gray-400 text-sm">Présentiel +<br/>Accompagnement en ligne</p>
            </div>
          </div>
